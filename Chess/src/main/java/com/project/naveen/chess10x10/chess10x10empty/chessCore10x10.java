...
*/
    ...
    void populateBoard(cell[][] board) {
        ...
        */
        whitePieces[13] = new piece(objectColour.white, pieceType.snake,
                board[5][7], new snake(), "w_snake");
        board[5][7].setPiece(whitePieces[13]);

        blackPieces[12] = new piece(objectColour.black, pieceType.snake,
                board[2][0], new snake(), "b_snake");
